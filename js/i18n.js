...
const TRANSLATIONS = {
  ...
  en: {
    ...
    form_chapters_lbl: '📚 Chapters',
    form_add_chapter: '＋ Add a chapter',
    err_chapters: '⚠ Please add at least one chapter.',
  ...
  fr: {
    ...
    form_chapters_lbl: '📚 Chapitres',
    form_add_chapter: '＋ Ajouter un chapitre',
    err_chapters: '⚠ Ajoutez au moins un chapitre.',
  ...
  es: {
    ...
    form_chapters_lbl: '📚 Capítulos',
    form_add_chapter: '＋ Añadir un capítulo',
    err_chapters: '⚠ Por favor añade al menos un capítulo.',
